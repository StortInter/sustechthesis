...
\begin{document}
  ...
  \input{sections/examples/4-figures.tex}
  \input{sections/examples/5-tutorial.tex}
  \clearpage

  \参考文献
  \printbibliography[heading=none]\clearpage
  \附录
  \input{sections/examples/6-appendix.tex}\clearpage
  \致谢
  \input{sections/examples/7-acknowledge.tex}
\end{document}
